...
$(function() {
    $('.change__price_pc').on('click', function () {
        $('.tv').addClass('animated fadeInLeft none_rate');
        $('.pc').removeClass('none');
        $('#price .change__price_pc').addClass('active');
        $('#price .change__price_tv').removeClass('active');
        $('.price__comment').removeClass('none_rate');
        return false;
    });

    $('.change__price_tv').on('click', function () {
        $('.pc').addClass('animated fadeInLeft none');
        $('.tv').removeClass('none');
        $('#price .change__price_pc').removeClass('active');
        $('#price .change__price_tv').addClass('active');
        $('.price__comment').addClass('animated fadeInLeft none');
        return false;
    });

    $('.click_msk').on('click', function () {
        $('.zlg').addClass('animated fadeInLeft none');
        $('.msk').removeClass('none');
        $('.click_zlg').removeClass('active_link');
        $('.click_msk').addClass('active_link');
        $('.zlg').addClass('animated fadeInLeft none');
        return false;
    });

    $('.click_zlg').on('click', function () {
        $('.msk').addClass('animated fadeInLeft none');
        $('.zlg').removeClass('none');
        $('.click_msk').removeClass('active_link');
        $('.click_zlg').addClass('active_link');
        $('.msk').addClass('animated fadeInLeft none');
        return false;
    });
    ...
    $(window).scroll(function() {
        ...
        if (scroll > offset) {
            $('.social__menu, .social__button').fadeOut(700);
        }

        else if (($(window).scrollTop()>700) && ($(window).width() > 1000)) {
            $('.social__menu, .social__button').fadeIn(900);
        }
    ...
    $('#form_contacts').click(function(){
        ...
        $('.messages').html("Сообщение отправлено...");
    });

    mapboxgl.accessToken = "pk.eyJ1IjoiYWxleDIwMTciLCJhIjoiY2sza3EybDk4MGQ5dDNibm05ejdvcDd3aiJ9.AxbLXhzbICJmcBhbxOpt6g";
    ...
    var map = new mapboxgl.Map({
        ...
        zoom: 13.69,
        center: [37.1686,55.9807]
    });

    map.on("load", function () {
        /* Image: An image is loaded and added to the map. */
        map.loadImage("img/log.png", function(error, image) {
